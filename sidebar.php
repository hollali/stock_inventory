...
<head>
    ...
    <title>Addys Inventory - Sidebar</title>
    ...
    <div>
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 w-72 bg-white transform -translate-x-72 lg:translate-x-0 transition-all duration-300 ease-in-out z-50 flex flex-col shadow-xl">
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <span id="sidebarLogo" class="text-xl font-semibold text-gray-800">Purple Anex</span>
                    </div>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1 min-w-0 user-details">
                        <p class="text-sm font-medium text-gray-800 truncate">
                            <?= isset($_SESSION['user_name']) ? htmlspecialchars($_SESSION['user_name']) : 'Adelaide' ?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <nav id="sidebarLinks" class="flex-1 overflow-y-auto py-4 px-3">
                <div class="space-y-1">
                    <!-- Dashboard -->
                    <a href="index.php" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors duration-200 group <?= $current_page == 'index.php' ? 'bg-blue-50 text-blue-600' : '' ?>" data-page="index.php">
                        <svg class="w-5 h-5 <?= $current_page == 'index.php' ? 'text-blue-600' : 'text-gray-400' ?> group-hover:text-blue-600 transition-colors duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-4 border-t border-gray-200 footer-info">
                <div class="text-xs text-gray-400 text-center">
                    <p>Version 2.0.0</p>
                    <p class="mt-1">© <?= date('Y') ?> Addys Inventory</p>
                </div>
            </div>
        </div>
